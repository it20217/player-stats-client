...
function RegistrationSuccess() {
  ...
  return (
    <>
      <div className="flex absolute top-0 h-full w-full bg-white">
        <div className="bg-white h-full w-full flex justify-center items-center">
          <div className="px-4 py-12">
            <div
              role="alert"
              id="alert"
              className="w-full mx-auto bg-white py-8 px-4 relative rounded-md"
            >
              ...
              <div className="mx-auto">
                ...
                <p className="mt-4 mb-3 text-2xl font-semibold leading-normal text-center text-gray-800">
                  Registration successful 
                </p>
                <div className="flex items-center justify-center mt-4 gap-x-3">
                  <p
                    onClick={() => navigate('/login')}
                    className="text-base font-medium leading-3 text-center text-gray-600 cursor-pointer"
                  >
                    Back to Login
                  </p>
                </div>
