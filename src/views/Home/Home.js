    ...
    <div className="overflow-y-hidden">
      <div className="relative flex justify-center items-center md:flex md:justify-end">
        ...
        <div className="w-full custom h-full flex lg:h-96 px-4 z-10 items-start md:items-start md:px-6 xl:px-20 ">
          <button 
            className="mt-6 w-full md:w-auto lg:mt-8 py-2 md:py-3 px-10 flex justify-center duration-700 hover:-translate-y-1 ease-in-out items-center relative rounded-md text-lg font-medium text-white"
